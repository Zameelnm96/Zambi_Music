package com.example.zambimusic.ui2.service;
...
//Invoked when the audio focus of the system is updated.
    ...
    private void initMediaPlayer() {
        ...
        try {
            ...
            mediaPlayer.setDataSource(this, Uri.parse(activeAudio.getUri()));
        } catch (IOException e) {
            e.printStackTrace();
            stopSelf();
        }
    ...
    private void register_playNewAudio() {
        ...
        IntentFilter filter = new IntentFilter(MainActivity3.Broadcast_PLAY_NEW_AUDIO);
